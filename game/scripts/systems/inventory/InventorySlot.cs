...
public partial class InventorySlot : Button
{
    ...
    {
        Inventory.SetInfoText(Item.IsNone ? "" : Item.UnwrapOrDefault().Name);
    }

    private void OnMouseExited()
    {
        Inventory.SetInfoText("");
    }
    ...
    private void OnPressed()
    {
        ...
        var removeAfterUse = Item.UnwrapOrDefault().OnUse(Inventory.GetParent<CharacterBody3D>());
    ...
    private void DropItem()
    {
        ...
        Item.Match(
            some =>
            {
                ...
                var body = (FirstPersonController)Inventory.GetParent<CharacterBody3D>();
